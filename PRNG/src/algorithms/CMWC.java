...
public class CMWC extends Random {
    ...
    /**
     * @param seeds      given seeds to use. Only r will be used. If fewer (or none)
     *                   are provided, the remaining seeds are generated
     * @param carry      The initial carry value to use
     * @param r          Number lag cycles to use. Must be a power of 2.
     * @param multiplier Multiplier to use. Depending on the r value chosen, different
